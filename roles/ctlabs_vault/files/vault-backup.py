...
DATA_DIR       = "/opt/vault/data"       # The path in your storage "file" { path = "..." } block
CONFIG_DIR     = "/etc/vault.d"          # Where your vault.hcl and certs live
VAULT_USER     = "vault"                 # The Linux user that runs the Vault service
VAULT_GROUP    = "vault"                 # The Linux group for the Vault service
RETENTION_DAYS = 30
...
def cleanup_old_backups():
    ...
    for filename in os.listdir(BACKUP_DIR):
        if filename.startswith("vault-") and filename.endswith(".tar.gz"):
